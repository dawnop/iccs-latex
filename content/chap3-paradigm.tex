...
%available in MPLs, so our discussion of paradigms is based on FP and OOP\@.
...
%For the core concepts of OOP, there is not much difference in the level of support of these of MPLs.
...
%
%The other example is Kotlin, which has better support for both FP and OOP\@.
